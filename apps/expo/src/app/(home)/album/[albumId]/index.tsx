import GalleryTile from "@/src/components/Album/GalleryTile";
import FloatingActionButton from "@/src/components/FloatingActionButton";
import { NotFoundScreen } from "@/src/components/NotFound";
...
export default function () {
    ...
    useEffect(() => {
        const subscription = Orientation.addOrientationChangeListener((event) => {
            clearTimeout(orientationTimeoutRef.current as ReturnType<typeof setTimeout>);
